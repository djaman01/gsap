  ...
  useGSAP(() => {
    ...
    boxes.forEach((e) => {
      ...
      gsap.to(e, {
        ...
        scrollTrigger: {
          trigger: e,
          start:"top bottom", //When the top of the element hits the bottom of the viewport the animations will begin / Donc si on voit le rose d'abord il va bouger et le orange ne vougera que quand on le verra
